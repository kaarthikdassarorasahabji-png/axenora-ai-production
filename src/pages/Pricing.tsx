...
const plans = [
  ...
  { 
    ...
    features: ["3 AI Chatbots", "WhatsApp + Website Integration", "2,000 Conversations/month", "AI Calling Agent (100 mins)", "Priority Support", "Advanced Analytics"], 
    popular: true 
  },
  { 
    name: "Scale", 
    price: "₹59,999", 
    period: "/month", 
    description: "For established businesses ready to fully automate operations.", 
    features: ["Unlimited AI Chatbots", "All Integrations", "10,000 Conversations/month", "AI Calling Agent (500 mins)", "Dedicated Account Manager", "Custom Workflows"], 
    popular: false 
  },
  { 
    name: "Enterprise", 
    ...
    features: ["Everything in Scale", "Custom AI Development", "Unlimited Usage", "SLA Guarantee", "On-premise Options", "24/7 Premium Support"], 
    popular: false 
  },
];
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {plans.map((plan, index) => (
              <motion.div 
                ...
                className={`relative p-6 rounded-2xl bg-card border ${plan.popular ? "border-primary glow" : "border-border"}`}
              >
                ...
                {plan.name === "Enterprise" ? (
                  ...
                  <Link to="/payment">
                    <Button className={plan.popular ? "btn-primary w-full" : "btn-secondary w-full"}>Get Started</Button>
                  </Link>
                )}
              </motion.div>
            ))}
